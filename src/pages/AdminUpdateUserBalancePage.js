    ...
    return (
        <div className="admin-container">
            <div className="admin-table">
                <div className="table">
                    <h1 className="title-table">Update a User Balance</h1>
                            ...
                            <div className="table">
                                ...
                                {user.validateStatus ? (
                                    <div className="row">
                                        ...
                                        <div className="div-button">Credit <input type="number" onChange={(e) => setCreditUnit(e.target.value)}></input><button onClick={addBalanceHandler}>Add Balance</button><button onClick={deductBalanceHandler}>Deduct Balance</button></div>
                                    </div>
                                ) : (
