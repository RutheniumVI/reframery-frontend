                ...
                <div className = "box">
                    {data.users.map((user) =>(
                        <div className = "profile-show" key={user.id}>
                            ...
                            src={user.image} alt="profile-image"/>, add your item here:</h1> 
                            ...
                            <input type = "text" className="profile-input" placeholder=" "/> <br/>
                            <Link to = "/my-item"><button className="profile-button">Add</button></Link>
                        </div>
                    ))}
                </div>
            </div>
