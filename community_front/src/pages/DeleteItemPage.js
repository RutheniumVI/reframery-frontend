                ...
                <div className = "box">
                    {data.input_products.map((input_product) =>(
                        <div className = "profile-show" key={input_product.id}>
                            ...
                            src={input_product.image} alt="profile-image"/>, delete your item here:</h1> 
                            ...
                            <input type = "text" className="profile-input" placeholder={input_product.address}/>
                            <h2 className="profile-h2">Description</h2>
                            <textarea type = "text" className="profile-input" placeholder={input_product.description}/>
                            <h2 className="profile-h2">Price</h2>
                            <input type = "text" className="profile-input" placeholder={input_product.price}/> <br/>
                            <Link to = "/my-item"><button className="profile-button">Delete</button></Link>
                        </div>
                    ))}
                </div>
            </div>
